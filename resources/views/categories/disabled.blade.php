...
{{--@section('btn_toolbar')--}}
{{--    <a href="{{route('categories.index')}}" class="btn btn-sm btn-primary" >All Categories</a>--}}
{{--@endsection--}}
...
@section('toolbar_path')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Disabled Categories</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
            ...
            <table class="table align-middle gs-0 gy-5">
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div style="text-align: start" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">
                                <form method="post" action="{{route('categories_status.update',$category->id)}}"
    ...
    @else
        There is No Disabled Category Yet!
    @endif
