        ...
        <form class="form" wire:submit.prevent="storePostData">
            <div class="modal-body py-10 px-lg-17">
                ...
                <div class="mb-5 fv-row">
                    <label class="required fs-5 fw-bold mb-2">Post Title</label>
                ...
                <!--begin::Input group-->
                <div class="mb-5 fv-row">
                    <label class="required fs-5 fw-bold mb-2">Post Body</label>
                    <textarea class="form-control form-control-solid" placeholder="Your Post Body"
                              wire:model.debounce.50ms="body" name="body"></textarea>
                    @error('body')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="storePostData">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_create_api_key_scroll" data-kt-scroll="true"
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea class="form-control form-control-solid" wire:model="body" rows="5"
                    ...
                    <div class="modal-footer flex-center">
                        ...
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" wire:target="storePostData" :disabled="$disabled" class="btn btn-primary">
